...
export function GameDetail({ game }: { game: GameDef }) {
  ...
  useEffect(() => {
    let cancelled = false;
    getLeaderboard(game.id, 10).then((result) => {
      ...
      <div className="grid lg:grid-cols-[1fr_340px] gap-6">
            ...
            <div className="relative flex flex-col sm:flex-row items-start gap-6">
              ...
              >
                <game.icon
                  ...
                  style={{
                    color: game.color,
                    filter: `drop-shadow(0 0 12px ${game.color})`,
                  }}
                />
              </div>
              <div className="flex-1">
                ...
                <h1
                  className={`font-pixel text-xl sm:text-2xl ${a.text} mt-2 mb-3 leading-tight`}
                >
                  {game.title}
                </h1>
        ...
        <div className="bg-vault-panel border-2 border-vault-border rounded-lg p-5 h-fit">
          <div className="flex items-center gap-2 mb-4 pb-3 border-b border-vault-border">
            ...
            <h2 className="font-pixel text-xs text-neon-yellow">
            ...
            <div className="space-y-1.5">
              {scores.map((row, i) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`font-pixel text-[10px] ${medal} w-6 text-center`}
                    >
                      {i + 1}
                    </span>
